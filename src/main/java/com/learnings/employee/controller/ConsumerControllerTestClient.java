...
System.out.println("BG: service id-->" + serviceId);
		...
		ServiceInstance serviceInstance = clientInfo == null ? null : clientInfo.get(0);

		String baseUrl = serviceInstance == null ? "http://localhost:8080/employee" : serviceInstance.getUri().toString() + "/employee";
